...
public class AppProfileConsumerController {
    ...
    public AppProfileConsumerController() {
        ...
        properties.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "com.mtitek.spring.model");
        properties.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, AppProfile.class);
